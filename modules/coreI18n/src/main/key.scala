...
object I18nKey:
  ...
  object site:
    ...
    val `customCombination`: I18nKey = "customCombination"
    val `mixAppearanceOptions`: I18nKey = "mixAppearanceOptions"
    val `active`: I18nKey = "active"
    val `uiTheme`: I18nKey = "uiTheme"
    val `chooseAppearanceParts`: I18nKey = "chooseAppearanceParts"
    val `appearanceCategories`: I18nKey = "appearanceCategories"
    val `customImageUrl`: I18nKey = "customImageUrl"
    val `darkThemeDescription`: I18nKey = "darkThemeDescription"
    val `lightThemeDescription`: I18nKey = "lightThemeDescription"
